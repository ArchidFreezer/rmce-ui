          ...
          <div className={`form-panel ${viewing ? 'form-panel--view' : ''}`}>
            ...
            <section style={{ marginTop: 12 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12 }}>
                ...
                <LabeledInput label="Stat Loss Racial Type" tooltip="1 - 5, low is quicker stat loss" value={form.statLossRacialType} onChange={makeUnsignedIntOnChange<typeof form>('statLossRacialType', setForm)} disabled={viewing} error={errors.statLossRacialType} />
                ...
                <LabeledInput label="Build Modifier" tooltip="Modifier for build" value={form.buildModifier} onChange={makeUnsignedIntOnChange<typeof form>('buildModifier', setForm)} disabled={viewing} error={errors.buildModifier} />
